        ...
        <div class="col-lg-7 col-12">
            <div class="notes-content">
                <div class="notes-div">
                    ...
                    <section>
                        ...
                        <p class="mb-4 ms-4">The history of JavaScript is a rich and fascinating journey that highlights its evolution from a niche project into one of the most widely used programming languages in the world. Below is a detailed timeline of Javascript history, broken down into key milestones.</p>
                    </section>
            ...
            <div class="row my-4">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <a href="ch_1_L_3-java-javascript-and-python-by-deepak-smart-programming.php" class="btn btn-success">Next Topic <i
