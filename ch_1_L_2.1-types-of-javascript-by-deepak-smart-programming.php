        ...
        <div class="col-lg-7 col-12">
            <div class="notes-content">
                <div class="notes-div">
                    ...
                    <section>
                        <h4 class="notes-heading mt-5"><i class="bi bi-brightness-low-fill"></i>JavaScript Types</h4>
                        <p class="mb-4 ms-4">The history of JavaScript is a rich and fascinating journey that highlights
                            its evolution from a niche project into one of the most widely used programming languages in
                            the world. Below is a detailed timeline of Javascript history, broken down into key
                            milestones.</p>
