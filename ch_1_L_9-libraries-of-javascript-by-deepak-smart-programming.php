        ...
        <div class="col-lg-7 col-12">
            ...
            <div class="row my-4">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <a href="ch_2_L_1-syntax-in-javascript-deepak-smart-programming.php" class="btn btn-success">Next Topic <i
