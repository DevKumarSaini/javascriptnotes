        ...
        <div class="col-lg-7 col-12">
            <div class="notes-content">
                <div class="notes-div">
                    ...
                    <section>
                        <h4 class="notes-heading">In JavaScript, Comments</h4>
...
let x = 10; // This comment explains that x is initialized to 10
</code></pre>
...
let y = 20;
                        ...
                        <h5 class="notes-heading mt-4">Best Practices for Using Comments</h5>
                        <ol>
                        ...
                        <h5 class="notes-heading mt-4">Example of Comments in a JavaScript Program</h5>
