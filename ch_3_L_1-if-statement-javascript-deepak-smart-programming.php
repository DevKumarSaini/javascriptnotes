...
console.log(canVote);
                                ...
                                <p class="text-danger mt-3"><strong>Note: </strong>These examples illustrate how <code>if</code> statements work in JavaScript, providing flexibility in controlling the flow of execution based on conditions. If you have any further questions or need additional examples, feel free to ask!</p>
                            </div>
                        </div>
                    </section>
            ...
            <div class="row my-4">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <a href="ch_3_L_2-switch-statement-in-java-deepak-smart-programming.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
