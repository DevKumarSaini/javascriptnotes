...
// Code to be executed for each iteration
                                ...
                                <h5 class="notes-subheading mt-3">Parts of for-loop</h5>
                                <ul>
                        ...
                        <div>
                            ...
                            <div class="ms-4">
                                ...
                                <div class="ms-4">
                                    ...
                                    <pre><code class="language-javav">for (let i = 1; i <= 5; i++) {
    console.log(i);
}</code></pre>
                        ...
                        <div>
                            <div class="ms-4">
                                ...
                                <div class="ms-4">
                                    ...
                                    <pre><code class="language-java">for (let i = 0; i <= 10; i += 2) {
    console.log(i);
}</code></pre>
                                    <p><strong>Output</strong></p>
...
country USA</code></pre>
            ...
            <div class="row my-4">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <a href="ch_4_L_1.1-for-in-and-for-of-loop-in-javascript-deepak-smart-programming.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
