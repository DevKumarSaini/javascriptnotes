...
<head>
    ...
    <meta name="description" content="Understand the break statement in JavaScript and how it can be used to exit loops and switch statements prematurely." />
    <meta name="keywords" content="JavaScript break statement, exiting loops, loop control in JavaScript" />
        ...
        console.log("Color not recognized");
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-switch-statement.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-continue-statement.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
