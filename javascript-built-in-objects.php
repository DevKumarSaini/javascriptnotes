...
<head>
    ...
    <meta name="description" content="Learn about JavaScript's built-in objects like Arrays, Dates, and Math, and how to use them in your programs." />
    <meta name="keywords" content="JavaScript built-in objects, Arrays, Dates, Math, JavaScript functions" />
...
console.log(weakMap.get(obj)); // "value"</code></pre>
            ...
            <div class="row my-4">
                ...
                <a href="javascript-creating-objects.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-objects-methods.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
