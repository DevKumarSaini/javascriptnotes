...
<head>
    ...
    <meta name="description" content="Understand the different types of comments in JavaScript, including single-line and multi-line comments, and their usage in code." />
    <meta name="keywords" content="JavaScript comments, single-line comments, multi-line comments, commenting best practices" />
...
console.log("Area of the rectangle: " + area); // Log the area</code></pre>
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-syntax.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-keywords.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
