...
<head>
    ...
    <meta name="description" content="Learn how the continue statement in JavaScript works to skip an iteration of a loop and continue with the next one." />
    <meta name="keywords" content="JavaScript continue statement, skipping iterations, loop control in JavaScript" />
                        ...
                        <div>
                            ...
                            <div class="ms-4">
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <strong>Note: </strong>It is important to note that <code>continue</code> only works inside loops and will not affect the flow of control outside the loop.
                                </div>
...
console.log(i);  // Print only odd numbers</code></pre>
...
7</code></pre>
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-break-statement.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-return-statement.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
