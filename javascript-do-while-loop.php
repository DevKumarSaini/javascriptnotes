...
<head>
    ...
    <meta name="description" content="Learn how the do-while loop works in JavaScript to run a block of code at least once, then repeat based on a condition." />
    <meta name="keywords" content="JavaScript do-while loop, do-while loop syntax, looping in JavaScript" />
...
5</code></pre>
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-while-loop.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-oop-paradigm.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
