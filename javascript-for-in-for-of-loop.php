...
<head>
    ...
    <meta name="description" content="Understand the differences between the for-in and for-of loops in JavaScript, and how to use them for iterating over objects and arrays." />
    <meta name="keywords" content="JavaScript for-in loop, for-of loop, iterating over objects and arrays" />

    <title>Javascript for...in and for...of loop</title>
...
5</pre>
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-for-loop.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-while-loop.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
