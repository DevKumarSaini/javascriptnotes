                ...
                <div class="notes-div">
                    ...
                    <section>
                        ...
                        <div>
                            ...
                            <ul>
                                <li>JavaScript was created by <strong>Brendan Eich</strong> in <strong>just 10 days in May 1995</strong> while he was working at <strong>Netscape Communications Corporation</strong>, it became an <strong>ECMA standard in 1997</strong></li>
                                <li>Initially, it was called <strong title="A mocha is a coffee drink that combines espresso, steamed milk, and chocolate (either syrup, powder, or melted)">"Mocha"</strong> , then changed to <strong>LiveScript</strong> before finally being named <strong>JavaScript</strong>.</li>
                                <li>JavaScript is a <strong>high-level,</strong> <strong>interpreted</strong> programming language that's primarily used to create <strong>dynamic</strong> and <strong>interactive web pages</strong>.</li>
                                <li><strong>JavaScript is </strong>one of the core technologies of the web, alongside <strong>HTML and CSS</strong> </li>
                                <li><strong>Netscape</strong>, founded in <strong>1994</strong>, aimed to make the web more <strong>dynamic</strong> .</li>
                                <li>To achieve this, Netscape sought a <strong>"glue language"</strong> to enhance <strong>HTML's</strong> capabilities.</li>
                                <li>It can <strong>calculate</strong><strong>, manipulate</strong> and <strong>validate</strong> data in HTML dynamically.</li>
                                <li>
                                    <div class="alert alert-dark" role="alert">
                                        JavaScript has since become a <strong>cornerstone</strong> of web development, enabling <strong>Interactive</strong> and <strong>Dynamic web </strong> experiences.
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            <h4 class="notes-heading mt-5"><i class="bi bi-brightness-low-fill"></i>Features And Capabilities </h4>
                        ...
                        <div>
                            <h4 class="notes-heading mt-5"><i class="bi bi-brightness-low-fill"></i>Standards and Evolution</h4>
                            <ul>
                                <li><strong>Standards : </strong> <a target="_blank" href="https://262.ecma-international.org/15.0/index.html?_gl=1*hwf5tm*_ga*OTAyNTYwMzMyLjE3NDIxOTQ4MTA.*_ga_TDCK4DWEPP*MTc0MjU4NTE2OC4zLjAuMTc0MjU4NTE3Ny4wLjAuMA.."><strong>ECMA-262</strong></a> is the official standard for JavaScript.</li>
                        ...
                        <div>
                            <h5 class="notes-heading mt-5"><i class="bi bi-brightness-low-fill"></i>Benefits of JavaScript Over Other Languages</h5>
