...
<head>
    ...
    <meta name="description" content="Learn about object references in JavaScript, including how objects are assigned and passed by reference." />
    <meta name="keywords" content="JavaScript object reference, passing by reference, object assignment in JavaScript" />

    <title>Javascript Object reference</title>
...
<body>
  ...
  console.log(person.name);  // Output: Bob
            ...
            <div class="row my-4">
                ...
                <a href="javascript-objects-methods.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-this-keyword.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
