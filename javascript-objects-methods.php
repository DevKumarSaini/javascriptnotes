...
<head>
  ...
  <meta name="description" content="Understand JavaScript object methods, including how to call, define, and use methods in objects for various tasks." />
  <meta name="keywords" content="JavaScript object methods, calling object methods, defining methods, object functions" />
...
console.log(person.toLocaleString());  // Output: Alice is 25 years old
      ...
      <div class="row my-4">
        ...
        <a href="javascript-built-in-objects.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
        </div>
        <div class="col-6 d-flex justify-content-end">
          <a href="javascript-object-reference.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
        </div>
      </div>
