...
<head>
    ...
    <meta name="description" content="Learn about operators in JavaScript, including arithmetic, comparison, and logical operators, and their role in expressions." />
    <meta name="keywords" content="JavaScript operators, arithmetic operators, comparison operators, logical operators" />
        ...
        <div class="col-lg-7 col-12">
            <div class="notes-content">
                <div class="notes-div">
                    ...
                    <h3 class="text-center"> JavaScript Operators</h3>
                    <hr />
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-data-types.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-if-statement.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
