...
<head>
    ...
    <meta name="description" content="Learn how to use the switch statement in JavaScript to execute different code blocks based on multiple conditions." />
    <meta name="keywords" content="JavaScript switch statement, switch case, JavaScript conditional logic" />
...
console.log(`Your grade is: ${grade}`);</code></pre>
                                <p><strong>Output:</strong></p>
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-if-statement.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-break-statement.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
