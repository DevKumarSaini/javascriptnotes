...
<head>
    ...
    <meta name="description" content="Master the basic syntax of JavaScript, including variables, operators, functions, and control flow statements." />
    <meta name="keywords" content="JavaScript syntax, JavaScript variables, JavaScript functions, control flow in JavaScript" />
...
console.log("Sum of variable value and 20: " + result);
                        ...
                        <div>
                            ...
                            <div class="alert alert-danger" role="alert">
                                <strong>Note: </strong>Syntax is crucial for writing clear, functional code in programming languages like JavaScript. Understanding fixed and variable values helps you manage data and logic effectively in your programs.
                            </div>
                        </div>
                    </section>
            ...
            <div class="row my-4">
                <div class="col-6 d-flex justify-content-start">
                    <a href="javascript-libraries.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-comments.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
