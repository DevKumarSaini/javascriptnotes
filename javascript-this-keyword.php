...
<head>
    ...
    <meta name="description" content="Master the use of the 'this' keyword in JavaScript, and understand how it refers to the current object in various contexts." />
    <meta name="keywords" content="JavaScript this keyword, 'this' in JavaScript, object context, JavaScript syntax" />
...
person.greet();  // Output: "Alice"
            ...
            <div class="row my-4">
                ...
                <a href="javascript-object-reference.php" class="btn btn-warning"><i class="bi bi-arrow-left"></i> Previous Topic</a>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <a href="javascript-json-object.php" class="btn btn-success">Next Topic <i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
